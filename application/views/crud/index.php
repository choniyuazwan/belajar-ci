                  ...
                  <?php foreach ($content->result_array() as $key): ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="<?php echo base_url() ?>index.php/crud/read/<?php echo $key['id'] ?>" class="btn btn-success btn-xs glyphicon glyphicon-eye-open"></a>
                        
                        <a href="<?php echo base_url() ?>index.php/crud/update/<?php echo $key['id'] ?>" class="btn btn-primary btn-xs glyphicon glyphicon-pencil"></a>
                        
                        <a href="<?php echo base_url() ?>index.php/crud/delete/<?php echo $key['id'] ?>" class="btn btn-danger btn-xs glyphicon glyphicon-trash"></a>
